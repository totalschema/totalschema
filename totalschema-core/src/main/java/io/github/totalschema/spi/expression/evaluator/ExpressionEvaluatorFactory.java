...
public interface ExpressionEvaluatorFactory {
    ...
    /**
     * Gets the singleton ExpressionEvaluatorFactory instance.
     *
     * @return the ExpressionEvaluatorFactory instance
     */
    static ExpressionEvaluatorFactory getInstance() {
        return ServiceLoaderFactory.getSingleService(ExpressionEvaluatorFactory.class)
                .orElseGet(DefaultExpressionEvaluatorFactory::new);
    }
