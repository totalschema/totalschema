...
public final class EnvironmentInitializerInterceptor extends CommandInterceptor {

    private final Environment environment;

    public EnvironmentInitializerInterceptor(CommandExecutor next, Environment environment) {
        super(next);
