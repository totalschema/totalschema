...
public final class ExpressionEvaluatorInitializerInterceptor extends CommandInterceptor {

    public ExpressionEvaluatorInitializerInterceptor(CommandExecutor next) {
        super(next);
    }
    ...
    public <R> R intercept(CommandContext context, Command<R> command, CommandExecutor next)
        ...
        ExpressionEvaluator expressionEvaluator =
                expressionEvaluatorFactory.getExpressionEvaluator(context);
