...
public class DefaultShellScriptRunnerFactoryTest {
    ...
    private static List<String> prefix(
            DefaultShellScriptRunnerFactory factory, String fileExtension) {
        return prefix(factory, EMPTY_CONFIG, fileExtension);
    }

    private static List<String> prefix(
            DefaultShellScriptRunnerFactory factory, Configuration config, String fileExtension) {
        ShellScriptRunner runner = factory.getRunner(CONNECTOR_NAME, config, fileExtension);
    ...
    public void testShScriptOnUnixUsesSh() {
        assertEquals(prefix(unixNoPwsh(), "sh"), List.of("sh"));
    }
    ...
    public void testOtherExtensionOnUnixUsesSh() {
        assertEquals(prefix(unixNoPwsh(), "txt"), List.of("sh"));
    }

    @Test
    public void testExtensionlessScriptOnUnixUsesSh() {
        assertEquals(prefix(unixNoPwsh(), "run"), List.of("sh"));
    }
    ...
    public void testShScriptOnWindowsUsesSh() {
        ...
        assertEquals(prefix(windowsNoPwsh(), "sh"), List.of("sh"));
    }
    ...
    public void testBatScriptOnWindowsUsesCmd() {
        assertEquals(prefix(windowsNoPwsh(), "bat"), List.of("cmd.exe", "/c"));
    }

    @Test
    public void testCmdScriptOnWindowsUsesCmd() {
        assertEquals(prefix(windowsNoPwsh(), "cmd"), List.of("cmd.exe", "/c"));
    }

    @Test
    public void testOtherExtensionOnWindowsUsesCmd() {
        assertEquals(prefix(windowsNoPwsh(), "txt"), List.of("cmd.exe", "/c"));
    }
    ...
    public void testBatScriptOnUnixThrowsIllegalStateException() {
        unixNoPwsh().getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "bat");
    }
    ...
    public void testCmdScriptOnUnixThrowsIllegalStateException() {
        unixNoPwsh().getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "cmd");
    }
    ...
    public void testPs1OnUnixWithoutPwshThrowsIllegalStateException() {
        unixNoPwsh().getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "ps1");
    }

    @Test
    public void testPs1ExtensionCaseInsensitiveOnWindowsWithoutPwsh() {
        assertEquals(
                prefix(windowsNoPwsh(), "PS1"),
    ...
    public void testStartCommandOverridesShOnUnix() {
        ...
        assertEquals(prefix(unixNoPwsh(), config, "sh"), List.of("bash", "-c"));
    }

    @Test
    public void testStartCommandOverridesPs1Detection() {
        // Even for a .ps1 extension the configured command wins
        Configuration config =
                Configuration.builder().set("start.command", "pwsh,-NonInteractive,-File").build();
        assertEquals(
                prefix(unixNoPwsh(), config, "ps1"), List.of("pwsh", "-NonInteractive", "-File"));
    }
    ...
    public void testStartCommandBypassesBatRestrictionOnUnix() {
        ...
        assertEquals(prefix(unixNoPwsh(), config, "bat"), List.of("wine", "cmd.exe", "/c"));
    }
    ...
    public void testStartCommandWithSingleToken() {
        ...
        assertEquals(prefix(unixNoPwsh(), config, "sh"), List.of("zsh"));
    }
    ...
    public void testStartCommandWithManyTokens() {
        ...
        assertEquals(prefix(unixNoPwsh(), config, "sh"), List.of("env", "VAR=value", "sh", "-x"));
    }
    ...
    public void testGetRunnerReturnsGenericShellScriptRunner() {
        ShellScriptRunner runner = unixNoPwsh().getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "sh");
    ...
    public void testGetRunnerReturnsFreshInstanceEachCall() {
        ...
        ShellScriptRunner first = factory.getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "sh");
        ShellScriptRunner second = factory.getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "sh");
    ...
    public void testDefaultConstructorCreatesFactory() {
        ...
        ShellScriptRunner runner = factory.getRunner(CONNECTOR_NAME, EMPTY_CONFIG, "sh");
        assertNotNull(runner);
    }
}
